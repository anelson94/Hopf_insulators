...
con1 = mlab.contour3d(Image1, contours=2, color = (1, 153/255, 153/255), transparent=True)
mlab.axes(con1, xlabel='', ylabel='', zlabel='', color = (0, 0, 0))
mlab.contour3d(Image2, contours=2, color = (153/255, 1, 153/255), transparent=True)
mlab.contour3d(Image3, contours=2, color = (153/255, 153/255, 1), transparent=True)
mlab.show()